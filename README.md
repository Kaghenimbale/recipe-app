...
```sh
  cd my-folder
  git clone https://github.com/Kaghenimbale/recipe-app
```
...
Feel free to check the [issues page](https://github.com/Kaghenimbale/recipe-app/issues).
...
This project is [MIT](https://github.com/Kaghenimbale/recipe-app/blob/dev/LICENSE) licensed.
